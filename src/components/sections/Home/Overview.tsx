...
const OverviewHome = () => {
  return (
    <>
      <div
        className="text-center font-archivo mx-4 center-custom flex-col bg-custom bg-cover bg-center 
      rounded-3xl space-y-6 h-[47vh] md:mx-12 md:h-[30vh] lg:mx-32 lg:h-[60vh]"
      >
        <div className="flex items-center space-x-2">
          <span className="w-12 h-[1px] bg-white md:bg-gray-500"></span>
          <span className="text-white md:text-gray-100 text-sm">
        ...
        <span
         ...
         text-3xl md:text-5xl  md:max-w-2xl lg:max-w-4xl"
        >
          Discover the last fashion trends here
        </span>
        <span className="text-white max-w-xs md:max-w-xl">
      ...
      {/* landing Text */}
      <div className="px-2 my-12 center-custom md:px-16 lg:px-32">
